...
| DAA-01                                    | ¿Son estos los únicos dos estados? ¿Sería útil un tercer estado como "Leyendo actualmente"?                                                                                           | Usabilidad de la aplicación.   | Alta      | Decide el agregar un estado                                                                                                         |
