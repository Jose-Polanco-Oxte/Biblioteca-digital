...
### Tareas
- [x] [Crear endpoint para añadir el nombre de usuario y validaciones en el endpoint](./tareas/endpoint-perfil.md)
...
### Tareas
- [ ] Crear endpoint para añadir libros
- [ ] Implementación de validaciones de libros en el endpoint
- [ ] Creación del formulario para libros y validaciones del lado del cliente
- [ ] Implementación offline de libros
- [ ] Creación del servicio de sincronización de libros pendientes